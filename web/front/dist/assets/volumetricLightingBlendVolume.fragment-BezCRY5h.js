import{JC as e,YC as t,sw as n}from"./index-CHiGcwTe.js";var r,i,a;n((()=>{t(),r=`volumetricLightingBlendVolumePixelShader`,i=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;var depthSampler: texture_2d<f32>;uniform invProjection: mat4x4<f32>;uniform outputTextureSize: vec2f;
...
`,e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=i),a={name:r,shader:i}}))();export{a as volumetricLightingBlendVolumePixelShaderWGSL};