...
#include <stdlib.h>
#include <stdio.h>
#include <sys/select.h> //ajout perso
...
int		main(int ac, char **av)
{
	...
	while (1)
	{
		...
		for (int fd = 0; fd <= max_fd; fd++)
		{
			...
			if (fd == sockfd)
			{
				socklen_t addr_len = sizeof(servaddr); addr_len n est utilise que dans la ligne ci-dessous puis le mettre audessus du while (1)
