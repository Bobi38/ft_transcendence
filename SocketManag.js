...
class SocketManag{
    constructor(){
        ...
        this.socketChatG = null;
        this.socketChatP = null;
        this.socketMorp = null;
    ...
    connect(){
        ...
        this.socketChatG = new WebSocket(`${protocol}//${host}/ws/chatG`);
        this.socketChatS = new WebSocket(`${protocol}//${host}/ws/chatP`);
        this.socketMorp = new WebSocket(`${protocol}//${host}/ws/morp`);
        this.socketPing = new WebSocket(`${protocol}//${host}/ws/goat`);
